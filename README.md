...
**WINDOWS:** Simply click twice on `ScanAllNet.pyw` or run using IDLE

**LINUX:** Not tested yet for GUIs

```bash
python(3) ScanAllNet.pyw
```

#### - No [CLI](https://en.wikipedia.org/wiki/Command-line_interface) available for this software -
...
-   Contact: [Mail](mailto:pro@quentium.fr?subject=[Apps]%20Contact%20for%20...)
